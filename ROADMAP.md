...
* ✌️ (DONE) Support Cypress 10 into Quasar Cypress AE, [beta is out now](https://github.com/quasarframework/quasar-testing/releases/tag/e2e-cypress-v5.0.0-beta.1)
