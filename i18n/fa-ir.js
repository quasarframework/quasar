export default {
  ...
  date: {
    ...
    daysShort: 'ی‌ش/دش/س‌ش/چ‌ش/پ‌ش/ج‌م/ش‌ن'.split('/'),
    months: 'ژانویه/فوریه/مارس/آپریل/مه/ژوئن/جولای/آگوست/سپتامبر/اکتبر/نوامبر/دسامبر'.split('/'),
    monthsShort: 'ژا/فو/ما/آپ/مه/ژو/جو/آگ/سپ/اک/نو/دس'.split('/'),
    firstDayOfWeek: 5,
    format24h: false
  },
  pullToRefresh: {
