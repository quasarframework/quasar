...
description: Vue directive that triggers an event when user scrolls and brings a component into view.
canonical: https://quasar.dev/vue-directives/scroll-fire
kinds: directive
generated: true
---
...
**API reference:** [ScrollFire](../../api/ScrollFire.md)
...
Source: [Basic.vue](../../examples/ScrollFire/Basic.vue)
