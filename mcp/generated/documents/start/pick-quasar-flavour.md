...
description: Get started with Quasar by picking one of its flavours: Quasar CLI (with Vite), Quasar Vite Plugin or UMD
canonical: https://quasar.dev/start/pick-quasar-flavour
kinds: guide
generated: true
---
...
| Feature                                                                                        | Quasar UMD | Quasar CLI (with Vite) | Quasar Vite Plugin         |
| ---------------------------------------------------------------------------------------------- | ---------- | ---------------------- | -------------------------- |
