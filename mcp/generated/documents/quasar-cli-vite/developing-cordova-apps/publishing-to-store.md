...
description: (@quasar/app-vite) How to publish a Quasar Cordova app to Google Play and the Apple App Store.
canonical: https://quasar.dev/quasar-cli-vite/developing-cordova-apps/publishing-to-store
kinds: guide
generated: true
---
