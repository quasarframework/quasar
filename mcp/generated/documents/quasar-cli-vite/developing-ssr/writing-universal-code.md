...
description: (@quasar/app-vite) Guide on how to write code for a Quasar server-side rendered app.
canonical: https://quasar.dev/quasar-cli-vite/developing-ssr/writing-universal-code
kinds: guide
generated: true
---
