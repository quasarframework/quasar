...
description: (@quasar/app-vite) How to use the Vue Router in a Quasar app.
canonical: https://quasar.dev/quasar-cli-vite/page-routing-with-vue-router
kinds: guide
generated: true
---
...
- /src
  - router
    - index.js — (or .ts)
  - pages
    - index.vue — layout for route "/"
    - index
      - (index).vue — page for route "/"
      - second.vue — page for route "/second"
    - admin.vue — layout for route "/admin"
    - admin
      - (index).vue — page for route "/admin"
      - account.vue — page for route "/admin/account"
