...
description: (@quasar/app-vite) The Quasar CLI list of commands when developing or building a desktop app.
canonical: https://quasar.dev/quasar-cli-vite/developing-electron-apps/build-commands
kinds: guide
generated: true
---
...
- dist-electron
  - Packaged — Packaged by @electron/packager or electron-builder
  - UnPackaged
    - assets/... — Vite compiled /src assets
    - electron-assets — /src-electron/electron-assets copied as-is
      - icons/ — Electron app icons
    - node_modules/
    - index.html
    - package.json
    - electron-main.js
    - electron-preload.cjs — (Electron has only CJS support for the preload scripts)
    - ...contents of /public
