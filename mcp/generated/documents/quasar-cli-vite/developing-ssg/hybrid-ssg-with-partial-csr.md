...
description: (@quasar/app-vite) How to handle a hybrid SSG with partial CSR with Quasar CLI.
canonical: https://quasar.dev/quasar-cli-vite/developing-ssg/hybrid-ssg-with-partial-csr
kinds: guide
generated: true
---
