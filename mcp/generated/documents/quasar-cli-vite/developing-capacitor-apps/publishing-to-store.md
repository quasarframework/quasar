...
description: (@quasar/app-vite) How to publish a Quasar hybrid mobile app to Google Play and the Apple App Store.
canonical: https://quasar.dev/quasar-cli-vite/developing-capacitor-apps/publishing-to-store
kinds: guide
generated: true
---
