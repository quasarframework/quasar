...
description: (@quasar/app-vite) What you need to do before developing a Quasar hybrid mobile app with Capacitor.
canonical: https://quasar.dev/quasar-cli-vite/developing-capacitor-apps/preparation
kinds: guide
generated: true
---
