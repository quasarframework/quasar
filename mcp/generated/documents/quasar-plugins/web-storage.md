...
description: A Quasar plugin that wraps the Local/Session Storage, retrieving data with its original JS type.
canonical: https://quasar.dev/quasar-plugins/web-storage
kinds: plugin
generated: true
---
...
- [SessionStorage](../../api/SessionStorage.md)
...
**API reference:** [LocalStorage](../../api/LocalStorage.md)

**API reference:** [SessionStorage](../../api/SessionStorage.md)

**Configuration:** register [LocalStorage, SessionStorage] through `framework.plugins` in `quasar.config`.
