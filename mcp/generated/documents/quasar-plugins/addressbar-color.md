...
description: A Quasar plugin for changing the addressbar color on newer mobile browsers.
canonical: https://quasar.dev/quasar-plugins/addressbar-color
kinds: plugin
generated: true
---
...
- [AddressbarColor](../../api/AddressbarColor.md)
