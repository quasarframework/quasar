...
description: How to setup your machine for a Quasar App Extension development and getting started quickly.
canonical: https://quasar.dev/app-extensions/development-guide/introduction
kinds: guide
generated: true
---
...
- . — PNPM workspace with /ae and /playground
  - ae — The App Extension that you will publish
    - package.json
    - src
      - templates/ — optional folder for spawning files
      - runtime/ — optional folder with UI stuff
      - index.js — (or .ts) Described in Index API
      - install.js — (or .ts) Described in Install API
      - prompts.js — (or .ts) Described in Prompts API
      - uninstall.js — (or .ts) Described in Uninstall API
  - playground/ — A @quasar/app-vite project folder to test/develop with
