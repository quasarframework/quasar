...
description: Tips and tricks on how to provide UI elements to the host app of a Quasar App Extension.
canonical: https://quasar.dev/app-extensions/common-formulas-and-patterns/provide-ui-elements
kinds: guide
generated: true
---
...
- .
  - /ae — Your App Extension
    - src
      - runtime — UI elements
        - boot.register.js — (or .ts) boot file for injecting component
        - MyComponent.vue — (or .js or .ts) the component file
      - index.js — (or .ts) Described in Index API
  - /playground — Testing/Development app (a @quasar/app-vite project)
    - src
      - pages
        - index
          - test1.vue — Example of page using the component
