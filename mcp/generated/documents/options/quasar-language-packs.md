...
description: How to configure the Quasar language packs in a Quasar app.
canonical: https://quasar.dev/options/quasar-language-packs
kinds: plugin
generated: true
---
...
**API reference:** [Lang](../../api/Lang.md)

**Configuration:** configure `framework.config.lang` in `quasar.config`.
