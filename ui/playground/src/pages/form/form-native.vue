      ...
      <q-card-section>
        ...
        <div class="q-my-lg">
          <q-radio
            ...
            :dark="dark"
            color="primary"
            :label="`${disable ? 'Disabled ' : ''}Option 1`"
          ...
          <q-radio
            ...
            :dark="dark"
            color="accent"
            :label="`${disable ? 'Disabled ' : ''}Option 2`"
            :keep-color="keepColor"
          />
          <q-radio
            name="radio1"
            ...
            :dark="dark"
            color="teal"
            :label="`${disable ? 'Disabled ' : ''}Option 3`"
            :keep-color="keepColor"
          />
          <q-radio
            name="radio1"
            ...
            :dark="dark"
            color="teal"
            :label="`${disable ? 'Disabled ' : ''}Option Obj`"
            :keep-color="keepColor"
          />
        </div>
        ...
        <div class="q-my-lg">
          <q-checkbox
            ...
            :dark="dark"
            color="primary"
            :label="`${disable ? 'Disabled ' : ''}Checkbox 1`"
            :keep-color="keepColor"
          />
          <q-checkbox
            name="checkbox2"
            ...
            :dark="dark"
            color="accent"
            :label="`${disable ? 'Disabled ' : ''}Checkbox 2`"
            :keep-color="keepColor"
          />
          <q-checkbox
            name="checkbox3"
            ...
            :dark="dark"
            color="teal"
            :label="`${disable ? 'Disabled ' : ''}Checkbox 3`"
            :keep-color="keepColor"
          />
          <q-checkbox
            name="checkbox4"
            ...
            :dark="dark"
            color="teal"
            :label="`${disable ? 'Disabled ' : ''}Checkbox Obj 4`"
            :keep-color="keepColor"
          />
        </div>
        ...
        <div class="q-my-lg">
          <q-toggle
            ...
            :dark="dark"
            color="primary"
            :label="`${disable ? 'Disabled ' : ''}Toggle Label`"
            :keep-color="keepColor"
          />
          <q-toggle
            name="toggle2"
          ...
          <q-toggle
            ...
            :dark="dark"
            color="teal"
            :label="`${disable ? 'Disabled ' : ''}Toggle Label Obj`"
            :keep-color="keepColor"
          />
        </div>
