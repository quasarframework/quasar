  ...
  <div class="q-layout-padding button-group-test">
    <div class="q-gutter-md">
      <q-btn-group push glossy>
        <q-btn color="yellow" push to="/a"> Link /a </q-btn>
        <q-btn color="amber" push to="/b">
          Link /b
          <q-badge color="red" floating> 4 </q-badge>
        </q-btn>
        <q-btn color="orange" push to="/c"> Link /c </q-btn>
      </q-btn-group>

      <q-btn-group unelevated>
        <q-btn color="yellow" unelevated to="/a"> Link /a </q-btn>
        <q-btn color="amber" unelevated to="/b">
          Link /b
          <q-badge color="red" floating> 4 </q-badge>
        </q-btn>
        <q-btn color="orange" unelevated to="/c"> Link /c </q-btn>
      </q-btn-group>
      ...
      <q-btn-group spread>
        <q-btn color="yellow"> Btn 1 </q-btn>
        <q-btn color="amber">
          Btn 2
          <q-badge color="red" floating> 4 </q-badge>
        </q-btn>
        <q-btn color="orange"> Btn 3 </q-btn>
      </q-btn-group>
    </div>

    <div
      v-for="{ push, flat, outline } in types"
      :key="push + '#' + flat + '#' + outline"
    >
      <div v-for="rounded in options" :key="rounded">
        <div v-for="size in sizes" :key="size" class="q-ma-sm">
          ...
          <div class="q-gutter-md">
            ...
            <q-btn-group :push="push" :rounded="rounded" :outline="outline">
              <q-btn color="blue" flat :size="size"> First </q-btn>
              ...
              <q-btn color="deep-orange" flat :size="size"> Separated </q-btn>
            </q-btn-group>
          </div>
        </div>
      </div>
