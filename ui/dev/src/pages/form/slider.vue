<template>
  <div class="column no-wrap" style="height: 100vh" :class="dark ? 'bg-black text-white' : ''">
    ...
    <div class="col scroll q-pl-md q-pr-xl q-gutter-y-lg">
      ...
      <div>
        <q-slider v-model="nullInnerMinMax" :min="0" :max="50" :inner-min="10" :inner-max="35" :inner-track="innerTrack" />
        <q-slider v-model="innerMinMax" :min="0" :max="50" :inner-min="10" :inner-max="35" :inner-track="innerTrack" />
        <q-slider v-model="innerMinMax" :min="0" :max="50" color="green" :inner-min="15" :inner-max="40" :inner-track="innerTrack" markers />
      </div>
