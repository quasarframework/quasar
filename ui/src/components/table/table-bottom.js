  ...
  methods: {
    __getBottomDiv (h) {
      ...
      if (this.nothingToDisplay === true) {
        ...
        return h('div', {
          staticClass: staticClass + ' q-table__bottom--nodata ' + this.props.tableBottomClass,
      ...
      if (bottom !== void 0) {
        return h('div', {
          staticClass: staticClass + ' ' + this.props.tableBottomClass,
          style: this.props.tableBottomStyle
        }, [ bottom(this.marginalsScope) ])
      }
      ...
      if (this.hidePagination !== true) {
        return h('div', {
          staticClass: staticClass + ' justify-end ' + this.props.tableBottomClass,
          style: this.props.tableBottomStyle
