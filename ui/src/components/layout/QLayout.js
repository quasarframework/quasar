...
export default Vue.extend({
  ...
  render (h) {
    const layout = h('div', {
      ...
      h(QScrollObserver, {
        on: getCache(this, 'scroll') || cache(this, 'scroll', { scroll: this.__onPageScroll })
      }),

      h(QResizeObserver, {
        on: getCache(this, 'resizeOut') || cache(this, 'resizeOut', { resize: this.__onPageResize })
      })
    ], this, 'default'))
    ...
    return this.container === true
      ? h('div', {
        ...
        h(QResizeObserver, {
          on: getCache(this, 'resizeIn') || cache(this, 'resizeIn', { resize: this.__onContainerResize })
        }),
        h('div', {
