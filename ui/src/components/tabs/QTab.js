  ...
  methods: {
    ...
    __getContent (h) {
      ...
      const node = [
        ...
        h('div', {
          staticClass: `q-tab__content self-stretch flex-${this.tabs.vertical && this.tabs.inlineLabel ? this.tabs.alignLabel : 'center'} relative-position q-anchor--skip non-selectable`,
