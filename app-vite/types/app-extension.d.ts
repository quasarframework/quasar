...
import type { QuasarSsrManifest } from "./configuration/ssr-conf.d.ts";
...
export interface IndexAPI extends BaseAPI, SharedIndexInstallAPI {
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendBexManifestJson: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendElectronPackageJson: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendPWAManifestJson: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendPWAGenerateSWOptions: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendPWAInjectManifestOptions: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendSSRPackageJson: Callback<
    (
      pkgJson: { [index in string]: any },
      api: IndexAPI
    ) =>
   ...
   */
  readonly extendSSRManifestJson: Callback<
    (
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendSSRGenerateSWOptions: Callback<
    (
      config: GenerateSWOptions,
      api: IndexAPI
    ) => void | GenerateSWOptions | Promise<void | GenerateSWOptions>
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendSSRInjectManifestOptions: Callback<
    (
      config: InjectManifestOptions,
      api: IndexAPI
    ) => void | InjectManifestOptions | Promise<void | InjectManifestOptions>
   ...
   * @type ssrManifest {@link QuasarSsrManifest}
   */
  readonly extendSSGManifestJson: Callback<
    (
      ssrManifest: QuasarSsrManifest,
      api: IndexAPI
    ) => void | QuasarSsrManifest | Promise<void | QuasarSsrManifest>
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendSSGGenerateSWOptions: Callback<
    (
      config: GenerateSWOptions,
      api: IndexAPI
    ) => void | GenerateSWOptions | Promise<void | GenerateSWOptions>
   ...
   * @param api {@link IndexAPI}
   */
  readonly extendSSGInjectManifestOptions: Callback<
    (
      config: InjectManifestOptions,
      api: IndexAPI
    ) => void | InjectManifestOptions | Promise<void | InjectManifestOptions>
