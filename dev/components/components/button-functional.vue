  ...
  <div>
    <div class="q-layout-padding">
      ...
      <div class="row flex-center q-my-md">
        <q-btn round class="on-left" icon="remove" v-touch-repeat:0:600.enter.space="() => { testN -= 1 }" />
        <q-btn push round class="on-left" icon="remove" v-touch-repeat.enter.space="() => { testN -= 1 }" />
        <q-input type="number" v-model="testN" align="right" />
        <q-btn push round class="on-right" icon="add" v-touch-repeat.enter.space="() => { testN += 1 }" />
        <q-btn round class="on-right" icon="add" v-touch-repeat:0:600.enter.space="() => { testN += 1 }" />
      </div>
