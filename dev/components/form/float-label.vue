...
&.q-field-focus
  ...
  & > i.item-primary
     color $form-active-color
  & > .q-float-label > label:after,
  & > label:after
    color $required-color
  & > .q-float-label > div:before
      visibility visible
      width 100%
      left 0
