          ...
          <div class='card-content'>
            ...
            <div class="grid row wrap ">
              ...
              <div class="width-2of4 sm-width-1of1">
                ...
                <q-field item label="Player" icon="face" layout="inline" validate validate-msg="Both names are required.">

                  <q-field item label="First Name" validate :validate-msg="false" @click='doClick'>
                    <input type="text" class="demoInputWidth" v-model="example.firstName" required />
                  </q-field>

                  <q-field item label="Last Name" validate :validate-msg="false" @click='doClick'>
