...
<template>
  <div>
    ...
    <div class="layout-padding">
      ...
      <div class="card">
        ...
        <div>
          <q-float-label label="Enter data" layout="inplace" icon="android" width="grow" class="my-android-field">
            <input type="text">
          </q-float-label>
 ...
 -->
          ...
          <q-float-label label="Stacked Layout" layout="stacked" width='max'>
            <input>
          </q-float-label>
...
&.q-field-invalid > .q-field-inner > span
  visibility visible
  opacity 1
...
// List View -------------------------
div.list > div.q-field
  width 100%

div.list > div.q-field > i.item-primary
  width 48px
