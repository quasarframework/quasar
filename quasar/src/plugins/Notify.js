    ...
    return h('div', { staticClass: 'q-notifications' }, positionList.map(pos => {
      ...
      return h('transition-group', {
        ...
        return h('div', {
          ...
          h('div', { staticClass: 'row items-center ' + (notif.multiLine ? 'qcol-1of1' : 'col') }, [
            notif.icon ? h(QIcon, {
          ...
          notif.actions ? h('div', {
            staticClass: 'q-notification__actions row items-center ' + (notif.multiLine ? 'qcol-1of1 justify-end' : 'col-auto')
