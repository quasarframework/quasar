<template>
  <div>
    <div class="q-layout-padding" :class="`bg-${dark ? 'black' : 'white'}${dark ? ' text-white' : ''}`">
      ...
      <q-toggle @change="onChange" @input="onInput" v-model="checked" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" label="Toggle Label" :dark="dark" :dense="dense" :keep-color="keepColor"/>
      <q-toggle v-model="checked" color="orange" label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" color="teal" label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>

      <p class="caption">
        Label on the left side
      </p>
      <q-toggle v-model="checked" color="orange" left-label label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" color="teal" left-label label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" color="blue" left-label label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      ...
      <q-toggle @change="onChange" v-model="selection" val="one" label="One" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <br>
      <q-toggle @change="onChange" v-model="selection" val="two" label="Two" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <br>
      <q-toggle @change="onChange" v-model="selection" val="three" label="Three" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>

      <p class="caption">
        With Icon
      </p>
      <q-toggle v-model="checked" :icon="icons.alarm" label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" :icon="icons.mail" color="secondary" label="Toggle Label" :dark="dark" :dense="dense"
                :keep-color="keepColor"/>
      <q-toggle v-model="checked" :unchecked-icon="icons.visibility_off" :checked-icon="icons.visibility" color="red"
                label="Toggle Label" :dark="dark" :dense="dense" :keep-color="keepColor"/>
...
<script>
const DEFAULT_ICON_SET = 'material-icons'
// @TODO : Add and test with other icons set
const oIcons = {
  'fontawesome-v5': {
    alarm: 'fa fa-clock',
    mail: 'fa fa-envelope',
...
export default {
  ...
  computed: {
    icons () {
      return oIcons[this.$q.iconSet.name] || oIcons[DEFAULT_ICON_SET]
    }
  }
}
</script>
