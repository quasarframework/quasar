...
* If you use `keep-alive-include` or `keep-alive-exclude` props for QCarousel you must use slide names that are valid component names (no spaces allowed, don't start with a number).
:::
