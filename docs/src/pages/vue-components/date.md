...
<doc-example title="Multiple days" file="SelectionMultiple" overflow />
...
<doc-example title="Single Range" file="SelectionRange" overflow />

<doc-example title="Multiple ranges" file="SelectionRangeMultiple" overflow />
...
<doc-example title="Custom title and subtitle" file="CustomTitleSubtitle" overflow />
...
<doc-example title="Default view" file="DefaultView" overflow />
...
<doc-example title="First day of week" file="FirstDayOfWeek" overflow />
...
<doc-example title="Today button" file="TodayBtn" overflow />
...
<doc-example title="Events" file="Events" overflow />

<doc-example title="Event color" file="EventColor" overflow />
...
<doc-example title="Navigation boundaries" file="NavigationBoundaries" overflow />
...
<doc-example title="With QInput" file="Input" />
