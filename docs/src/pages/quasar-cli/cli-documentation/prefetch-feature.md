...
---
The PreFetch is a feature **available when using Quasar CLI** that allows a way for the components to be picked up by Vue Router (defined in `/src/router/routes.js`) to:
* pre-fetch data
* validate the route
