...
**Sass** or **SCSS** (recommending any of the two flavors) and **Stylus** are the out of the box supported css preprocessors through Quasar CLI, should you want to use them.
