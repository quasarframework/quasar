...
:::tip
Some **advanced** scenarios require to use a custom starter kit (eg. testing or personal presets). In those **rare** cases, you can use `--kit` option. Read more about this into [`create` command](/quasar-cli/cli-documentation/commands-list#create) description.
:::
