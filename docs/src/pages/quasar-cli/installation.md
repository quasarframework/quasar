...
Note that you don't need separate projects if you want to build any of the available platform builds. This one project can seamlessly handle all of them.
