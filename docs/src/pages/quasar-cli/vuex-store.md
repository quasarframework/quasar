...
If by contrast, you did not choose to use Vuex when you create a project folder with Quasar CLI, Adding a Vuex Module (see below) is all you need to do to `install` vuex.
