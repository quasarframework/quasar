...
| `$q.electron` | Object | Reference to Electron global object. Available only when running under an Electron app. **It is NOT enabled by default. [More info](/quasar-cli/developing-electron-apps/node-integration)**. |
