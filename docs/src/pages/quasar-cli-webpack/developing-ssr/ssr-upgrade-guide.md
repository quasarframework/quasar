...
5. Review quasar.config.js > ssr properties. Most of the old props have been removed and replaced by [new ones](/quasar-cli/developing-ssr/configuring-ssr#quasar-conf-js).
...
* You might want to check out the [new configuration](/quasar-cli/developing-ssr/configuring-ssr) properties available through quasar.config.js > ssr.
