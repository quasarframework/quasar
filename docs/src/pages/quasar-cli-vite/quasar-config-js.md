...
You will need the linting files already installed. If you don't know which those are, scaffold a new Quasar project folder (`yarn create quasar` or `npm init quasar` or `pnpm dx create-quasar`) and pick "Linting" when asked about it.
