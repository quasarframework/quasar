...
q-card(flat bordered)
  ...
  q-card-section.q-gutter-xs.q-pa-sm.row.items-center
    q-select(
  ...
  doc-code.relative-position(lang="js", :code="fileMainJs")

  q-separator

  doc-code.relative-position(lang="js", :code="fileViteConfigJs")

  template(v-if="useSassVariables")
    q-separator

    doc-code.relative-position(:code="fileSassVariables")
</template>
