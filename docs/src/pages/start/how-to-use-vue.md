...
Quasar comes with a few custom [Vue Directives](https://v2.vuejs.org/v2/guide/custom-directive.html). These directives can be applied on almost any DOM element or Component.
