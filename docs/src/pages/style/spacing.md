...
| `q-` | `p` (padding) | `t` (top) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-pt-auto` |
...
| `q-` | `p` (padding) | `r` (right) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-pr-auto` |
...
| `q-` | `p` (padding) | `b` (bottom) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-pb-auto` |
...
| `q-` | `p` (padding) | `l` (left) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-pl-auto` |
...
| `q-` | `p` (padding) | `a` (all) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-pa-auto` |
...
| `q-` | `p` (padding) | `x` (left & right) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-px-auto` |
...
| `q-` | `p` (padding) | `y` (top & bottom) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-py-auto` |
...
| `q-` | `m` (margin) | `t` (top) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-mt-auto` |
...
| `q-` | `m` (margin) | `r` (right) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-mr-auto` |
...
| `q-` | `m` (margin) | `b` (bottom) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-mb-auto` |
...
| `q-` | `m` (margin) | `l` (left) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-ml-auto` |
...
| `q-` | `m` (margin) | `a` (all) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-ma-auto` |
...
| `q-` | `m` (margin) | `x` (left & right) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-mx-auto` |
...
| `q-` | `m` (margin) | `y` (top & bottom) | `auto` (ONLY for specific margins: q-ml-*, q-mr-*, q-mx-*) | `q-my-auto` |
