...
.landing.text-white
      ...
      .row.justify-center
        ...
        .flex.justify-end
          .q-gutter-sm
            ...
            .q-pt-md.q-pl-sm.row.items-center
  ...
  section.padding(style="background: rgba(0,0,0,.5);")
    div
      ...
      .q-gutter-md.row
        q-btn(color="primary", push, icon-right="launch", label="SPA (Single Page App)", to="/quasar-cli/developing-spa/introduction")
        q-btn(color="teal", push, icon-right="launch", label="PWA (Progressive Web App)", to="/quasar-cli/developing-pwa/introduction")
        q-btn(color="accent", push, icon-right="launch", label="SSR (Server-side Rendered App)", to="/quasar-cli/developing-ssr/introduction")
        q-btn(color="orange", push, icon-right="launch", label="Hybrid Mobile App", to="/quasar-cli/developing-mobile-apps/introduction")
        q-btn(color="red", push, icon-right="launch", label="Multi-platform Desktop App", to="/quasar-cli/developing-electron-apps/introduction")
